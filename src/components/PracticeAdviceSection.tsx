    ...
    return (
        <section className="section-container py-12">
            ...
            <div className="container-card flex justify-center">
                <div className="flex w-full flex-col lg:flex-row lg:justify-between items-center lg:items-start">
                    <div className="card w-80 bg-white rounded-lg shadow-md border border-borderColor mr-10 mb-10">
