  ...
  return (
    <section className="container-comment-section w-full p-4 bg-gray-100">
      <div className="information-client my-20">
        ...
        <p className="text-2x1 text-gray-500">Problems trying to resolve the conflict between</p>
        <p className="text-2x1 text-gray-500">the thow major realms of Classical physics: Newtonian mechanics</p>
      </div>
      <div className="comment-container flex justify-center space-x-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="comment-section flex-1 bg-white p-6 rounded-lg shadow-md">
